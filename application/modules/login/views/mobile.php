         ...
         <div class="container">
            <div class="row">
               <div class="col-xl-9 justify-content-center mx-auto text-center">
                  <div class="card">
                     <div class="row">
                        <div class="col-md-12 col-lg-6 pr-0 d-none d-lg-block"> <img src="<?=base_url();?>uploads/login.jpg" alt="img" class="br-tl-2 br-bl-2 "> </div>
                        <div class="col-md-12 col-lg-6 pl-0 ">
                           <div class="card-body p-6 about-con pabout">
                              <br /><br />
                              <div class="card-title text-center  mb-4">Master Login</div>
                              <hr>
                              ...
                              <?php } ?>
                                <?php if($msg){ if($msg['action']=='0'){ ?>
                                    <form id="login_form" action="<?php echo site_url('login/sendotp');?>" method="POST">
                                <?php }elseif($msg['action']=='1'){ ?>
                                    <form id="login_form" action="<?php echo site_url('login/verifyotp');?>" method="POST">
                                <?php } }else{ ?>
                                    <form id="login_form" action="<?php echo site_url('login/sendotp');?>" method="POST">
                                <?php } ?>
                                 <div class="row">
                                    <div class="col-md-12">
                                       <div class="form-group">
                                          <input type="text" name="mobile" class="form-control" placeholder="Enter Registered Mobile Number" value="<?php echo set_value('mobile'); ?>" autocomplete="none"> 
                                       </div>
                                       <?php if($msg){ if($msg['action']=='1'){ ?>
                                       <div class="form-group">
                                ...
                                <?php if($msg){ if($msg['action']=='0'){ ?>
                                    <div class="form-footer mt-1"> <button type="submit" class="btn btn-success btn-block">Sent Code</button> </div>
                                <?php }else{ ?>
                                    <div class="form-footer mt-1"> <button type="submit" class="btn btn-success btn-block">Verify OTP</button> </div>
                                <?php } }else{ ?>
                                    <div class="form-footer mt-1"> <button type="submit" class="btn btn-success btn-block">Sent Code</button> </div>
                                <?php }  ?>
                              </form>
